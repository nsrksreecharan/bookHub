...
class BookShelvesRead extends Component {
  ...
  getData = async () => {
    ...
    const BooksApiUrl = `https://apis.ccbp.in/book-hub/books?shelf=READ&search=${searchText}`
    const option = {
      method: 'GET',
      headers: {
      ...
      <div className="BookShelvesRoute">
        ...
        <div className="BookShelves">
          <div className="BookShelvesHeadingContainer">
            <p className="BookShelvesHeading">Read Books</p>
...
export default BookShelvesRead
